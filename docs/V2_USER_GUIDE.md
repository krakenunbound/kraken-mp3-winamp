# Kraken MP3 Winamp v2 — User Guide
...
- **Always on top** (main window) applies to the whole player stack in v2.
...
| v2 layout / settings | Electron user-data for **Kraken MP3 Winamp v2** |

## Troubleshooting

| Issue | Try |
|-------|-----|
| “Already running” | Close all Kraken MP3 Winamp v2 windows or end stray processes in Task Manager |

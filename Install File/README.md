...
Use **`Kraken MP3 Setup 1.0.0.exe`** for a normal Windows install (Start menu + optional desktop shortcut).

Use **`Kraken MP3 1.0.0.exe`** if you want a portable copy with no installer.
